...
if ( isset( $_GET['type'] ) ) {
	 ...
	 * @since 2.5.0
	 *
	 * @param string $type The default media upload type. Possible values includes
...
if ( $tab == 'type' || $tab == 'type_url' || ! array_key_exists( $tab, media_upload_tabs() ) ) {
	 ...
	 * media upload type. Possible values includes 'image', 'audio', 'video',
	 * 'file', etc.
	 *
	 ...
	 * media upload tab. Possible values includes 'library' (Media Library),
