...
final class WP_Privacy_Policy_Content {
	...
	public static function notice( $post = null ) {
		...
		$message = __( 'Need help putting together your new Privacy Policy page? Check out our guide for recommendations on what content to includes, along with policies suggested by your plugins and theme.' );
	...
	public static function privacy_policy_guide() {
		...
		<div class="privacy-text-box">
			<div class="privacy-text-box-head">
				...
				<p><?php _e( 'We have suggested the sections you will need. Under each section heading you will find a short summary of what information you should provide, which will help you to get started. Some sections includes suggested policy content, others will have to be completed with information from your theme and plugins.' ); ?></p>
	 ...
	 *
	 * @param bool $description Whether to includes the descriptions under the section headings. Default false.
	...
	public static function get_default_content( $description = false, $blocks = true ) {
		...
		/* translators: default privacy policy text. */
		$strings[] = '<p>' . $suggested_text . __( 'Articles on this site may includes embedded content (e.g. videos, images, articles, etc.). Embedded content from other websites behaves in the exact same way as if the visitor has visited the other website.' ) . '</p>';
		/* translators: default privacy policy text. */
		...
		if ( $description ) {
			/* translators: privacy policy tutorial. */
			$strings[] = '<p class="privacy-policy-tutorial">' . __( 'In this section you should explain what measures you have taken to protect your users&#8217; data. This could includes technical measures such as encryption; security measures such as two factor authentication; and measures such as staff training in data protection. If you have carried out a Privacy Impact Assessment, you can mention it here too.' ) . '</p>';
		}
