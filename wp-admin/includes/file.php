...
function _wp_handle_upload( &$file, $overrides, $time, $action ) {
	 ...
	 * }
	 * @param string $context The type of upload action. Values includes 'upload' or 'sideload'.
	 */
 ...
 *
 * This function will includes the chosen transport and attempt connecting.
 *
...
function wp_privacy_process_personal_data_export_page( $response, $exporter_index, $email_address, $page, $request_id, $send_as_email, $exporter_key ) {
	...
	if ( $send_as_email ) {
		...
		// Modify the response to includes the URL of the export file so the browser can fetch it.
		$export_file_url = get_post_meta( $request_id, '_export_file_url', true );
