...
class WP_Plugins_List_Table extends WP_List_Table {
	...
	public function prepare_items() {
		...
		if ( ! is_multisite() || ( $screen->in_admin( 'network' ) && current_user_can( 'manage_network_plugins' ) ) ) {
			 ...
			 * plugins to filter the display of. Contexts includes 'mustuse' and 'dropins'.
			 *
			 * @since 3.0.0
			 *
	...
	public function single_row( $item ) {
		...
		if ( $screen->in_admin( 'network' ) ) {
			 ...
			 * @since 3.1.0
			 *
			 * @param string[] $actions     An array of plugin action links. By default this can includes 'activate',
			 *                              'deactivate', and 'delete'.
			 * @param string   $plugin_file Path to the plugin file relative to the plugins directory.
			 * @param array    $plugin_data An array of plugin data. See `get_plugin_data()`.
			 * @param string   $context     The plugin context. By default this can includes 'all', 'active', 'inactive',
			 ...
			 *
			 * @param string[] $actions     An array of plugin action links. By default this can includes 'activate',
			 *                              'deactivate', and 'delete'. With Multisite active this can also includes
