 ...
 *                                              screen. Post edit screen contexts includes 'normal', 'side',
 *                                              and 'advanced'. Comments screen contexts includes 'normal'
 ...
 *                                        includes 'normal', 'side', and 'advanced'. Comments screen contexts
 *                                        includes 'normal' and 'side'. Menus meta boxes (accordion sections)
 ...
 * @param string   $page     The slug-name of the settings page on which to show the section. Built-in pages includes
 ...
 *                                       includes 'primary', 'small', and 'large'. Default 'primary'.
 ...
 * @param string       $type             Optional. The type and CSS class(es) of the button. Core values
 *                                       includes 'primary', 'small', and 'large'. Default 'primary large'.
