...
function make_site_theme_from_oldschool( $theme_name, $template ) {
	 ...
	 * TODO: This does not copy arbitrary includes dependencies. Only the standard WP files are copied.
	 */
	$files = array(
		'index.php'             => 'index.php',
	...
	foreach ( $files as $oldfile => $newfile ) {
		...
		// Update the blog header includes in each file.
		...
		if ( $lines ) {
			...
			foreach ( $lines as $line ) {
				...
				$line = str_replace( "<?php includes(ABSPATH . 'wp-comments.php'); ?>", '<?php comments_template(); ?>', $line );
