 ...
 * includes the plugin file. If the plugin fails, then the redirection will not
 ...
 *                             includes lowercase alphanumeric, dashes, and underscores characters to be compatible
 *                             with sanitize_key().
 ...
 *                              and only includes lowercase alphanumeric, dashes, and underscores characters
