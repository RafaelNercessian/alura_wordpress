...
class WP_Plugin_Install_List_Table extends WP_List_Table {
	...
	public function prepare_items() {
		 ...
		 * @since 2.7.0
		 *
		 * @param string[] $tabs The tabs shown on the Plugin Install screen. Defaults includes 'featured', 'popular',
		 ...
		 * Default tabs includes 'featured', 'popular', 'recommended', 'favorites', and 'upload'.
		 *
		 * @since 3.7.0
		 *
