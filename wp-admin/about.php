	...
	<div class="wrap about-wrap full-width-layout">
			...
			<div class="column is-vertically-aligned-center">
				...
				<p>
					...
					printf(
						...
						__( 'Building on <a href="%1$s">the Site Health features introduced in 5.1</a>, this release adds two new pages to help debug common configuration issues. It also adds space where developers can includes debugging information for site maintainers.' ),
		...
		<div class="has-2-columns">
			...
			<div class="column aligncenter">
				...
				<p><?php _e( 'Thirteen new icons includes Instagram, a suite of icons for BuddyPress, and rotated Earth icons for global inclusion. Find them in the Dashboard and have some fun!' ); ?></p>
			</div>
		</div>
