 ...
 *
 * The template is included using require, not require_once, so you may includes the
 ...
 *
 * Possible values for `$show` includes:
 *
 ...
 * On the post edit screen several actions can be used to includes additional editors
 ...
 * number.
 *
 * You can includes the previous and next links in the list by setting the
 ...
 *     @type bool   $prev_next          Whether to includes the previous and next links in the list. Default true.
