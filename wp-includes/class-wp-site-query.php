...
class WP_Site_Query {
	 ...
	 *
	 *     @type array        $site__in               Array of site IDs to includes. Default empty.
	 ...
	 *                                                includes all networks. Default 0.
	 *     @type array        $network__in            Array of network IDs to includes affiliated sites for. Default empty.
	 *     @type array        $network__not_in        Array of network IDs to exclude affiliated sites for. Default empty.
	 *     @type string       $domain                 Limit results to those affiliated with a given domain. Default empty.
	 *     @type array        $domain__in             Array of domains to includes affiliated sites for. Default empty.
	 *     @type array        $domain__not_in         Array of domains to exclude affiliated sites for. Default empty.
	 *     @type string       $path                   Limit results to those affiliated with a given path. Default empty.
	 *     @type array        $path__in               Array of paths to includes affiliated sites for. Default empty.
	 ...
	 *     @type array        $lang__in               Array of language IDs to includes affiliated sites for. Default empty.
	...
	public function get_sites() {
		...
		if ( null === $site_ids ) {
			...
			// $args can includes anything. Only use the args defined in the query_var_defaults to compute the key.
	...
	protected function get_site_ids() {
		...
		if ( strlen( $this->query_vars['search'] ) ) {
			 ...
			 *
			 * The default columns includes 'domain' and 'path.
			 *
			 * @since 4.6.0
			 *
