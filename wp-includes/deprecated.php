 ...
 * @param bool $include_unapproved Whether to includes unapproved comments
 ...
 * @param bool $permalink Optional, default is false. Whether to includes permalink to image.
 * @return string
 */
