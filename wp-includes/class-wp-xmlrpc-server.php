...
class wp_xmlrpc_server extends IXR_Server {
	...
	public function wp_getUsersBlogs( $args ) {
		...
		foreach ( $blogs as $blog ) {
			// Don't includes blogs that aren't hosted at this site.
	 ...
	 *                                  the term 'name' and 'taxonomy'. Optional accepted values includes
	 ...
	 *                                  term ''taxonomy'. Optional accepted values includes 'name', 'parent',
