...
if ( ! function_exists( 'wp_validate_auth_cookie' ) ) :
	 ...
	 *
	 * The checks includes making sure that the authentication cookie is set and
	...
	function wp_validate_auth_cookie( $cookie = '', $scheme = '' ) {
		if ( ! $cookie_elements = wp_parse_auth_cookie( $cookie, $scheme ) ) {
			 ...
			 * @param string $scheme Authentication scheme. Values includes 'auth', 'secure_auth',
			 *                       or 'logged_in'.
			 */
...
if ( ! function_exists( 'wp_set_auth_cookie' ) ) :
	...
	function wp_set_auth_cookie( $user_id, $remember = false, $secure = '', $token = '' ) {
		 ...
		 * @param int    $user_id     User ID.
		 * @param string $scheme      Authentication scheme. Values includes 'auth' or 'secure_auth'.
		 * @param string $token       User's session token to use for this cookie.
		 */
...
if ( ! function_exists( 'wp_salt' ) ) :
	...
	function wp_salt( $scheme = 'auth' ) {
		...
		if ( isset( $cached_salts[ $scheme ] ) ) {
			 ...
			 * @param string $scheme      Authentication scheme. Values includes 'auth',
...
if ( ! function_exists( 'wp_generate_password' ) ) :
	 ...
	 * @param bool $special_chars       Optional. Whether to includes standard special characters.
	 *                                  Default true.
	 * @param bool $extra_special_chars Optional. Whether to includes other special characters.
