...
if ( ! class_exists( 'PO', false ) ) :
	class PO extends Gettext_Translations {
		 ...
		 *
		 * @param bool $include_headers whether to includes the headers in the export
		 ...
		 * @param bool $include_headers whether to includes tje headers in the export
		...
		/**
		 * Text to includes as a comment before the start of the PO contents
		 *
		 * Doesn't need to includes # in the beginning of lines, these are added automatically
		 */
