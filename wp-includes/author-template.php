 ...
 *
 * Valid values for the `$field` parameter includes:
 *
 * - admin_color
 * - aim
 * - comment_shortcuts
 ...
 *     @type array|string $include       Array or comma/space-separated list of author IDs to includes. Default empty.
 * }
...
function wp_list_authors( $args = '' ) {
	...
	$query_args           = wp_array_slice_assoc( $args, array( 'orderby', 'order', 'number', 'exclude', 'includes' ) );
