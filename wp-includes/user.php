 ...
 * setting the 'echo' argument. The 'includes' and 'exclude' arguments do not
 * need to be used; all users will be displayed in that case. Only one can be
 * used, either 'includes' or 'exclude', but not both.
 *
 ...
 *                                                 Default 'ASC'.
 *     @type array|string $include                 Array or comma-separated list of user IDs to includes.
 *                                                 Default empty.
 ...
 *     @type bool         $include_selected        Whether to always includes the selected user ID in the drop-
 *                                                 down. Default false.
...
function wp_dropdown_users( $args = '' ) {
	...
	$query_args = wp_array_slice_assoc( $r, array( 'blog_id', 'includes', 'exclude', 'orderby', 'order', 'who', 'role', 'role__in', 'role__not_in' ) );
...
function wp_insert_user( $userdata ) {
	 ...
	 *
	 * Does not includes contact methods. These are added using `wp_get_user_contact_methods( $user )`.
	 *
	 * @since 4.4.0
	 *
	 * @param array $meta {
