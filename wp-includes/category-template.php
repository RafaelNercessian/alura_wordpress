 ...
 *     @type bool|int     $show_count        Whether to includes post counts. Accepts 0, 1, or their bool equivalents.
 *                                           Default 0.
...
function wp_dropdown_categories( $args = '' ) {
	...
	if ( empty( $categories ) && ! $r['hide_if_empty'] && ! empty( $r['show_option_none'] ) ) {
		 ...
		 * just prior to display via this filter. Filterable arguments includes
 ...
 *     @type bool         $hierarchical          Whether to includes terms that have non-empty descendants.
