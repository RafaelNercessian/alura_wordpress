...
class WP_Rewrite {
	...
	public function rewrite_rules() {
		 ...
		 *
		 * Likely date archives would includes /yyyy/, /yyyy/mm/, and /yyyy/mm/dd/.
		 *
		 * @since 1.5.0
		 *
		 ...
		 *
		 * Likely root-level archives would includes pagination rules for the homepage
		 ...
		 *
		 * Likely comments feed archives includes /comments/feed/, and /comments/feed/atom/.
		 *
		 * @since 1.5.0
		 *
		 ...
		 *
		 * Likely search-related archives includes /search/search+query/ as well as
		 ...
		 *
		 * Likely author archives would includes /author/author-name/, as well as
