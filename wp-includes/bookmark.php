 ...
 *                                    Default -1.
 *     @type string   $category       Comma-separated list of category ids to includes links from.
 *                                    Default empty.
 ...
 *     @type string   $include        Comma-separated list of bookmark IDs to includes. Default empty.
...
function get_bookmarks( $args = '' ) {
	...
	$inclusions = '';
	if ( ! empty( $r['includes'] ) ) {
		$r['exclude']       = '';  //ignore exclude, category, and category_name params if using includes
		$r['category']      = '';
		$r['category_name'] = '';
		$inclinks           = wp_parse_id_list( $r['includes'] );
		if ( count( $inclinks ) ) {
