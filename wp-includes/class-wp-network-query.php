...
class WP_Network_Query {
	 ...
	 *
	 *     @type array        $network__in          Array of network IDs to includes. Default empty.
	 ...
	 *     @type array        $domain__in           Array of domains to includes affiliated networks for. Default empty.
	 *     @type array        $domain__not_in       Array of domains to exclude affiliated networks for. Default empty.
	 *     @type string       $path                 Limit results to those affiliated with a given path. Default empty.
	 *     @type array        $path__in             Array of paths to includes affiliated networks for. Default empty.
