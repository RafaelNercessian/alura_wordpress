...
function get_page_of_comment( $comment_ID, $args = array() ) {
	 ...
	 * @param array $args {
	 *     Arguments used to calculate pagination. These includes arguments auto-detected by the function,
...
function wp_transition_comment_status( $new_status, $old_status, $comment ) {
	 ...
	 *
	 * Typical comment types includes an empty string (standard comment), 'pingback',
	 * or 'trackback'.
	 *
	 * @since 2.7.0
	 *
...
function wp_set_comment_status( $comment_id, $comment_status, $wp_error = false ) {
	 ...
	 *
	 * @param int         $comment_id     Comment ID.
	 * @param string|bool $comment_status Current comment status. Possible values includes
