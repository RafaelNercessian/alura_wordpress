...
function get_default_feed() {
	 ...
	 * @since 2.5.0
	 *
	 * @param string $feed_type Type of default feed. Possible values includes 'rss2', 'atom'.
	 *                          Default 'rss2'.
	 */
...
function get_the_content_feed( $feed_type = null ) {
	 ...
	 * @param string $feed_type Type of feed. Possible values includes 'rss2', 'atom'.
	 *                          Default 'rss2'.
	 */
...
function get_the_category_rss( $type = null ) {
	 ...
	 * @param string $type     Type of feed. Possible values includes 'rss2', 'atom'.
	 *                         Default 'rss2'.
	 */
 ...
 * @since 2.8.0
 *
 * @param string $type Type of feed. Possible values includes 'rss', rss2', 'atom', and 'rdf'.
 */
