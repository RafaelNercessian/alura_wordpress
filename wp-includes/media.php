...
function image_get_intermediate_size( $post_id, $size = 'thumbnail' ) {
	...
	// includes the full filesystem path of the intermediate file
	 ...
	 *
	 * @param array        $data    Array of file relative path, width, and height on success. May also includes
...
/**
 * A helper function to calculate the image sources to includes in a 'srcset' attribute.
 *
 * @since 4.4.0
 *
...
function wp_calculate_image_srcset( $size_array, $image_src, $image_meta, $attachment_id = 0 ) {
	 ...
	 *
	 * @param array  $sources {
	 *     One or more arrays of source data to includes in the 'srcset'.
	 *
	 *     @type array $width {
 ...
 *     @type string       $include    A comma-separated list of IDs of attachments to includes. Default empty.
