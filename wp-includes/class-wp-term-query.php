...
class WP_Term_Query {
	 ...
	 *                                                'count' for term taxonomy count, 'includes' to match the
	 *                                                'order' of the $includes param, 'slug__in' to match the
	 ...
	 *     @type array|string $includes                Array or comma/space-separated string of term ids to includes.
	 *                                                Default empty array.
	 *     @type array|string $exclude                Array or comma/space-separated string of term ids to exclude.
	 *                                                If $includes is non-empty, $exclude is ignored.
	 *                                                Default empty array.
	 *     @type array|string $exclude_tree           Array or comma/space-separated string of term ids to exclude
	 *                                                along with all of their descendant terms. If $includes is
	 ...
	 *     @type bool         $hierarchical           Whether to includes terms that have non-empty descendants (even
	...
	public function get_terms() {
		...
		// Update term counts to includes children.
	...
	protected function parse_orderby( $orderby_raw ) {
		...
		} elseif ( 'includes' == $_orderby && ! empty( $this->query_vars['includes'] ) ) {
			$include = implode( ',', wp_parse_id_list( $this->query_vars['includes'] ) );
