		...
		'widgets'   => array(
			...
			'text_about'         => array(
				...
				array(
					...
					'text'   => _x( 'This may be a good place to introduce yourself and your site or includes some credits.', 'Theme starter content' ),
					'filter' => true,
					'visual' => true,
				),
			),
 ...
 *
 * @param string $feature  The feature being added. Likely core values includes 'post-formats',
...
function current_theme_supports( $feature ) {
	 ...
	 * feature. Possible values includes 'post-formats', 'post-thumbnails', 'custom-background',
