...
class WP_Comment_Query {
	 ...
	 *     @type array        $author__in                Array of author IDs to includes comments for. Default empty.
	 *     @type array        $author__not_in            Array of author IDs to exclude comments for. Default empty.
	 *     @type array        $comment__in               Array of comment IDs to includes. Default empty.
	 ...
	 *                                                   Default 0.
	 *     @type array        $post__in                  Array of post IDs to includes affiliated comments for.
	 *                                                   Default empty.
	 ...
	 *     @type bool|string  $hierarchical              Whether to includes comment descendants in the results.
	...
	protected function get_comment_ids() {
		...
		if ( in_array( $this->query_vars['orderby'], array( 'none', array(), false ), true ) ) {
			...
			// To ensure determinate sorting, always includes a comment_ID clause.
